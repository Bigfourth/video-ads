(function () {
  ...
  function injectStyles() {
    ...
    st.textContent = `
      .xad-wrap{
        ...
        padding-top:46.25% !important;overflow:hidden;background:#000;
      }
      .xad-wrap.is-sticky{
        padding-top:0 !important;
      }
      @media(max-width:600px){
     .xad-wrap.is-sticky{padding-top:46.25% !important;}
		}
      .xad-wrap .video-js{
      ...
      /* ═══ STICKY ═══ */
      .xad-wrap.is-sticky{
        position:fixed!important;z-index:2147483647!important;overflow:visible;
        border-radius:4px;
  ...
  function mountOutstream(container) {
    ...
    const brandAttr = container.getAttribute("data-brand");
    const brand = brandAttr === null ? "BIGFOURTH" : brandAttr;
    ...
    let ratioPct = window.innerWidth <= 600 ? "46.25%" : "56.25%";
