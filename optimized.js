(function () {
  ...
  function mountInstream(el) {
    ...
    /* ── DOM ──
     * wrapper (xad-wrap, position:relative, padding-top)
     *   └ inner (xad-inner, position:absolute, fills wrapper)
     *       └ videoEl (video.video-js, position:absolute via CSS)
     *
     * inner div đảm bảo video-js luôn fill wrapper dù có bao nhiêu layer.
     */
  ...
  function mountOutstream(container) {
    ...
    let ratioPct = "56.25%"; // 16:9 default, sẽ cập nhật khi video load
    ...
    const videoSrc = container.getAttribute("data-src")
      || "https://cdn.pubabc.com/vietnam/Vietnam-4K-Epic-Roadtrip-Nature-landscapes-c.m3u8";
